...
:::message
2026/4/1 追記：
[Vim 9.2.0048](https://github.com/vim/vim/commit/71cc1b12cd2a92ceadff5cef73dcef387374ce36) にて、仮想端末の作成に winpty ではなく ConPTY がデフォルトで利用されるようになりました。この記事を書いた当時と比べると ConPTY が安定したことも期待でき、Windows 11 で新しめの Vim をお使いなのであれば、本節の ConPTY を用いる解決策の採用もかなり現実的かもしれません。
（本当は体感的に現在 ConPTY が安定していそうかなどを併せて書けたら良いのですが、色々あって筆者は Windows 環境をロストしてしまったため、現状そういった話をこの追記に含めることができませんでした...。申し訳ない🙏）
:::
...
:::message
ConPTY がデフォルトになった Vim 9.2.0048 以降では、上述した設定・手順は不要です。
:::
